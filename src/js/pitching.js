...
$(document).ready(function() {
  ...
  generateBlankRows();
  $('.table-pitching tbody').html(emptyRows);
  ...
  $('.table-pitching').on('mouseover', '.link-player', function() {
    showPlayerPopover(this);
  });

  $('.table-pitching').on('mouseout', '.link-player', function() {
...
function showPlayerPopover(link) {
  $('.table-pitching [data-toggle="popover"]').popover('hide');
  const playerID = $(link).closest('.table-pitching-row').attr('data-player-id');
